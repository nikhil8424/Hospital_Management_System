                    ...
                    case 5: {
                        ...
                        while (s5 == 1) {
                            ...
                            switch (c1) {
                                ...
                                case 2: {
                                    System.out.println("--------------------------------------------------------------------------------");
                                    System.out.println("          **EMERGENCY INFORMATION SECTION**");
                                    System.out.println("--------------------------------------------------------------------------------");
                                    ...
                                    System.out.print("Location to Reach: ");
                                    String location = input.next();
                                    System.out.print("Contact Number: ");
                                    String contactNumber = input.next();
                    
                                    // Save emergency information
                                    Fecility.saveEmergencyInfo(name, age, location, contactNumber);
